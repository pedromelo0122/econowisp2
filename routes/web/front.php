...
use App\Http\Controllers\Web\Front\Post\EscrowController as PostEscrowController;
			...
			->group(function ($router) {
				...
				Route::namespace('CreateOrEdit\MultiSteps')
					  ...
					  Route::controller(EditPaymentController::class)
                                ...
                                Route::post('posts/{hashableId}/escrow', [PostEscrowController::class, 'store'])->name('post.escrow.store');
                        });
