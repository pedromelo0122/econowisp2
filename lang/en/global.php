...
return [
    ...
    'user_social_login_not_found' => 'User social login not found',
        ...
        'buy_with_confidence' => 'Compra Segura',
        'escrow_transactions' => 'Compra Seguras',
        'escrow_meta_description' => 'Track your secured purchases and sales that are protected by escrow.',
        'escrow_balance_on_hold' => '$ Retenido',
        'escrow_balance_released' => '$ Liberado',
        'escrow_balance_purchases' => '$ En proceso',
        'escrow_no_balance' => 'Sin balance',
        'escrow_role' => 'Role',
        'escrow_role_buyer' => 'Comprador',
        'escrow_role_seller' => 'Vendedor',
        'counterparty' => 'Vendedor',
        'escrow_transactions_empty' => 'No encontramos transaciones seguras.',
        'escrow_transaction_created' => 'Your escrow request has been created. The seller has been notified.',
        'escrow_transaction_exists' => 'You already have an active escrow request for this listing.',
        'escrow_transaction_error_owner' => 'You cannot start an escrow for your own listing.',
        'escrow_transaction_invalid_amount' => 'This listing does not have a valid amount for escrow.',
        'escrow_transaction_error' => 'We could not create the escrow request. Please try again later.',
        'escrow_status_pending' => 'Pendiente',
        'escrow_status_funded' => 'Pagado',
        'escrow_status_released' => 'Liberado',
        'escrow_status_cancelled' => 'Cancelado',
        'escrow_status_disputed' => 'Disputa',
    ...
    'captcha_placeholder' => 'Ingresa el codigo de seguridad',
...
<br>Please leave this checkbox unchecked if you do not want to renew or upgrade your package, so no payment process will be triggered.',
    ...
    'search_cities' => 'Buscar por ciudad...',
    ...
    'account_stats' => 'Estadisticas de la cuenta',
    'entries_deleted' => 'Selected entries deleted successfully.',
    'no_entries_deleted' => 'No entries deleted.',
    'count_active_posts' => '{0} Anuncio Activo|{1} Anuncio Activos|[2,*] Anuncio Activo',
    'count_pending_approval_posts' => '{0} Pendiente|{1} Pendiente|[2,*] Pendiente',
    'count_archived_posts' => '{0} Archivado|{1} ArchivadoArchivado|[2,*] Archivado',
    'action_warning' => 'This action cannot be undone.',
    'change_language' => 'Change Language',
    'enter_your_name' => 'Tu Nombre',
    'enter_your_email' => 'Tu correo',
