...
use App\Services\Auth\App\Http\Middleware\Admin;
...
use extras\plugins\reviews\app\Http\Controllers\Web\Front\ReviewController as ReviewPublicController;
...
class ReviewsServiceProvider extends ServiceProvider
{
	...
	public function setupRoutes(Router $router): void
	{
		...
		Route::middleware(['admin', 'banned.user'])
			...
			->prefix(urlGen()->getAdminBasePath())
			->group(function ($router) {
