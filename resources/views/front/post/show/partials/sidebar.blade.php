				...
				<div class="container p-0 border-bottom pb-3 mb-3">
					<div class="row">
						...
						<div class="col-md-8 vstack gap-1">
                                                        ...
                                                        @if (data_get($user, 'is_verified_seller'))
                                                                <span class="d-inline-block mt-1">
                                                                        @include('front.layouts.partials.verified-seller-badge', ['class' => 'small'])
                                                                </span>
                                                        @endif
			...
			<div class="container p-0 {{ $evActionClass }} d-grid gap-2">
				...
				@if (!empty($authUser))
					...
					@else
                                                ...
                                                <form method="POST" action="{{ route('post.escrow.store', data_get($post, 'id')) }}">
                                                        @csrf
                                                        <button type="submit" class="btn btn-success">
                                                                <i class="bi bi-shield-check"></i> {{ t('buy_with_confidence') }}
                                                        </button>
                                                </form>
                                        @endif
