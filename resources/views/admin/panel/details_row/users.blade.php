<div class="mt-10 mb-10 ps-10 pe-10 pt-10 pb-10 bg-body">
    <div class="flex-row d-flex justify-content-center">
        <div class="col-lg-11 col-md-12">
            ...
            <div class="row">
                <div class="col-lg-3 col-md-4 col-sm-6 col-6 p-2 bg-light-inverse fw-bolder mb-1">{{ trans('admin.Verified Seller') }}</div>
                <div class="col-lg-9 col-md-8 col-sm-6 col-6 p-2 mb-1">
                    {!! ($entry->is_verified_seller == 1) ? '<i class="fa-regular fa-square-check"></i>' : '<i class="fa-regular fa-square"></i>' !!}
                </div>
            </div>
            <div class="row">
