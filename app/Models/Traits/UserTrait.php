...
trait UserTrait
{
	...
	public function crudPhoneColumn(?Panel $xPanel = null): string
	{
        ...
        public function crudVerifiedSellerColumn(?Panel $xPanel = null): string
        {
                return ajaxCheckboxDisplay(
                        $this->{$this->primaryKey},
                        $this->getTable(),
                        'is_verified_seller',
                        ($this->is_verified_seller ?? null)
                );
        }
	...
	// ===| OTHER METHODS |===
	public function impersonateInLineButton(?Panel $xPanel = null): string
{
	$out = '';
